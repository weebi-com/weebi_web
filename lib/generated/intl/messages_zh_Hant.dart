...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "aboutPartners": MessageLookupByLibrary.simpleMessage("歷史合作夥伴"),
    ...
    "billingLifetime": MessageLookupByLibrary.simpleMessage("終身"),
    "billingMyLicenses": MessageLookupByLibrary.simpleMessage("我的許可證"),
    "billingPurchase": MessageLookupByLibrary.simpleMessage("購買"),
    "billingPurchaseLicense": MessageLookupByLibrary.simpleMessage("購買許可證"),
    "billingPurchaseLicenseDescription": MessageLookupByLibrary.simpleMessage(
      "選擇套餐以開始使用 Weebi。",
    ),
    "billingRetry": MessageLookupByLibrary.simpleMessage("重試"),
    "billingUsers": MessageLookupByLibrary.simpleMessage("用戶"),
    ...
    "changeProfilePhoto": MessageLookupByLibrary.simpleMessage("更換照片"),
    ...
    "helpReadFaq": MessageLookupByLibrary.simpleMessage("閱讀常見問題"),
    "helpResourcesTitle": MessageLookupByLibrary.simpleMessage("資源"),
    "helpScopeBody": MessageLookupByLibrary.simpleMessage(
      "Web控制台可管理票據（查看、篩選、搜索）。文章、聯繫人和操作（銷售、採購、庫存移動等）目前僅在移動應用中可用。",
    ),
    "helpScopeTitle": MessageLookupByLibrary.simpleMessage("我可以在Web控制台做什麼？"),
    "helpWatchDemos": MessageLookupByLibrary.simpleMessage("觀看視頻演示"),
    ...
    "loremIpsum": MessageLookupByLibrary.simpleMessage(
      "這時候風雨也停止進行曲的合奏，四方雲集，由何處開始",
    ),
    "matchErrorText": MessageLookupByLibrary.simpleMessage("此字段與格式不匹配。"),
    "maxErrorText": m6,
    "maxLengthErrorText": m7,
    "menuAccesses": MessageLookupByLibrary.simpleMessage("訪問"),
    "menuBilling": MessageLookupByLibrary.simpleMessage("計費"),
    "menuBoutiques": MessageLookupByLibrary.simpleMessage("店鋪"),
    "menuDevices": MessageLookupByLibrary.simpleMessage("設備"),
    "menuFirm": MessageLookupByLibrary.simpleMessage("我的公司"),
    "menuScopeDisclaimer": MessageLookupByLibrary.simpleMessage(
      "文章、聯繫人和操作（銷售、採購、庫存移動等）目前僅在移動應用中可用。",
    ),
    "menuTickets": MessageLookupByLibrary.simpleMessage("票據"),
    "menuUsers": MessageLookupByLibrary.simpleMessage("用戶"),
    "minErrorText": m8,
    ...
    "recordSavedSuccessfully": MessageLookupByLibrary.simpleMessage("記錄已成功保存。"),
    ...
    "supportChatWhatsApp": MessageLookupByLibrary.simpleMessage("與Weebi支持聊天"),
    "supportEmailUs": MessageLookupByLibrary.simpleMessage("給我們發郵件"),
